                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('caraousel.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control-file @error('gambar_caraousel') is-invalid @enderror" id="gambar_caraousel" name="gambar_caraousel" required>
