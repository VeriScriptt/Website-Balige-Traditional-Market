                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('caraousel.update', $carousel->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control @error('deskripsi') is-invalid @enderror" id="deskripsi" name="deskripsi" required>{{ old('deskripsi', $carousel->deskripsi) }}</textarea>
                                            @error('deskripsi')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="gambar_caraousel">Image</label>
                                            <input type="file" class="form-control-file @error('gambar_caraousel') is-invalid @enderror" id="gambar_caraousel" name="gambar_caraousel">
                                            @error('gambar_caraousel')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                            <img src="{{ asset('storage/' . $carousel->gambar_caraousel) }}" alt="{{ $carousel->title }}" width="200" class="mt-2">
                                        </div>
